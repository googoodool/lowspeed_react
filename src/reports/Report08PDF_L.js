...
const genPDFClick = (data, startDate, endDate, startTime, endTime) => {
  ...
  doc.text(
    "รายงาน ค่าเฉลี่ยน้ำหนักรถแยกตามประเภท แบบรายปี (Low Speed)",
    148,
    33,
    "center"
  );
  ...
  footer();
  doc.save(
    "Report_LSP ค่าเฉลี่ยน้ำหนักรถแยกตามประเภทแบบรายปี" + dateTime + ".pdf"
  );
};

function Report08PDF_L({
  data,
  variant,
  color,
  buttonText,
