...
const genPDFClick = (data, startDate, endDate, startTime, endTime) => {
  ...
  doc.text("รายงานรถแยกตามประเภท แบบรายเดือน (Low Speed)", 145, 33, "center");
  doc.setFontSize(9);
  doc.text(
    "ข้อมูลวันที่ " +
      startDate +
  ...
  footer();
  doc.save("Report_LSP แยกตามประเภทรถแบบรายเดือน" + dateTime + ".pdf");
};

function Report04PDF_L({
  data,
  variant,
  color,
  buttonText,
