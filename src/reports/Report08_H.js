...
import Report08PDF_H from "./Report08PDF_H";
...
function Report08_H() {
  ...
  const url = "http://127.0.0.1:3001/api/HS_Report08";
    ...
    <Section>
      ...
      <div className="mainReport">
        ...
        <div className="mainReportName">
          รายงาน ค่าเฉลี่ยน้ำหนักรถแยกตามประเภท แบบรายปี
