...
import Report06PDF_H from "./Report06PDF_H";
...
const columns = [
  ...
  { id: "date", label: "วันที่", minWidth: 80, maxWidth: 80, align: "center" },
...
function Report06_H() {
  ...
  const url = "http://127.0.0.1:3001/api/HS_Report06";
    ...
    <Section>
      ...
      <div className="mainReport">
        ...
        <div className="mainReportName">
          รายงาน ค่าเฉลี่ยน้ำหนักรถแยกตามประเภท แบบรายวัน
