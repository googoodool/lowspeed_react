...
import Report07PDF_H from "./Report07PDF_H";
...
function Report07_H() {
  ...
  const url = "http://127.0.0.1:3001/api/HS_Report07";
    ...
    <Section>
      ...
      <div className="mainReport">
        ...
        <div className="mainReportName">
          รายงาน ค่าเฉลี่ยน้ำหนักรถแยกตามประเภท แบบรายเดือน
