...
const genPDFClick = (data, startDate, endDate, startTime, endTime) => {
  ...
  doc.text("รายงานรถแยกตามประเภท แบบรายเดือน", 150, 33, "center");
  doc.setFontSize(9);
  doc.text(
    "ข้อมูลวันที่ " +
      startDate +
  ...
  footer();
  doc.save("Report แยกตามประเภทรถแบบรายเดือน" + dateTime + ".pdf");
};

function Report04PDF_H({
  data,
  variant,
  color,
  buttonText,
