...
const genPDFClick = (data, startDate, endDate, startTime, endTime) => {
  ...
  doc.text("รายงานรถแยกตามประเภท แบบรายวัน (Low Speed)", 147, 33, "center");
  doc.setFontSize(9);
  doc.text(
    "ข้อมูลวันที่ " +
      startDate +
  ...
  footer();
  doc.save("Report_LSP แยกตามประเภทรถแบบรายวัน" + dateTime + ".pdf");
};

function Report03PDF_L({
  data,
  variant,
  color,
  buttonText,
