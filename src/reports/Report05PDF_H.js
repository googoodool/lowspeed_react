...
const genPDFClick = (data, startDate, endDate, startTime, endTime) => {
  ...
  doc.text("รายงานรถแยกตามประเภท แบบรายปี", 150, 33, "center");
  doc.setFontSize(9);
  doc.text(
    "ข้อมูลวันที่ " +
      startDate +
  ...
  footer();
  doc.save("Report แยกตามประเภทรถแบบรายปี" + dateTime + ".pdf");
};

function Report05PDF_H({
  data,
  variant,
  color,
  buttonText,
