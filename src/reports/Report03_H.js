...
import Report03PDF_H from "./Report03PDF_H";
...
const columns = [
  ...
  { id: "date", label: "วัน", minWidth: 80, maxWidth: 80, align: "center" },
...
function Report03_H() {
  ...
  const url = "http://127.0.0.1:3001/api/HS_Report03";
    ...
    <Section>
      ...
      <div className="mainReport">
        ...
        <div className="mainReportName">
          รายงาน ปริมาณรถแยกตามประเภท แบบรายวัน
