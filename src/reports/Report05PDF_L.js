...
const genPDFClick = (data, startDate, endDate, startTime, endTime) => {
  ...
  doc.text("รายงานรถแยกตามประเภท แบบรายปี (Low Speed)", 147, 33, "center");
  doc.setFontSize(9);
  doc.text(
    "ข้อมูลวันที่ " +
      startDate +
  ...
  footer();
  doc.save("Report_LSP แยกตามประเภทรถแบบรายปี" + dateTime + ".pdf");
};

function Report05PDF_L({
  data,
  variant,
  color,
  buttonText,
