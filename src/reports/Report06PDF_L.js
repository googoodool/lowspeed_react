...
const genPDFClick = (data, startDate, endDate, startTime, endTime) => {
  ...
  doc.text(
    "รายงาน ค่าเฉลี่ยน้ำหนักรถแยกตามประเภท แบบรายวัน (Low Speed)",
    145,
    33,
    "center"
  );
  ...
  footer();
  doc.save(
    "Report_LSP_ค่าเฉลี่ยน้ำหนักรถแยกตามประเภทแบบรายวัน" + dateTime + ".pdf"
  );
};

function Report06PDF_L({
  data,
  variant,
  color,
  buttonText,
