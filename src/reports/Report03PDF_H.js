...
const genPDFClick = (data, startDate, endDate, startTime, endTime) => {
  ...
  doc.text("รายงานรถแยกตามประเภท แบบรายวัน", 150, 33, "center");
  doc.setFontSize(9);
  doc.text(
    "ข้อมูลวันที่ " +
      startDate +
  ...
  footer();
  doc.save("Report แยกตามประเภทรถแบบรายวัน" + dateTime + ".pdf");
};

function Report03PDF_H({
  data,
  variant,
  color,
  buttonText,
